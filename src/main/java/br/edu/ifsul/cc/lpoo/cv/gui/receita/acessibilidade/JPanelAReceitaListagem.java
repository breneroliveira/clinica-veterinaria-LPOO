...
public class JPanelAReceitaListagem extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if(arg0.getActionCommand().equals(btnNovo.getActionCommand())) {
            ...
            pnlAReceita.getFormulario().setReceitaFormulario(null); // Limpando o formulário.
            ...
            if(indice > -1){
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Receita removida.", "Receita", JOptionPane.INFORMATION_MESSAGE);
                    populaTable(); // Refresh na tabela.

                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(this, "Erro ao remover receita: " + ex.getLocalizedMessage(), 
                                                 "Receitas", JOptionPane.ERROR_MESSAGE);
                    ex.printStackTrace();
                }                        
