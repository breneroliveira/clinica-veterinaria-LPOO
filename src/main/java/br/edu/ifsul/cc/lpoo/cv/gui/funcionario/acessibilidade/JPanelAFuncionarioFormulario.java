...
public class JPanelAFuncionarioFormulario extends JPanel implements ActionListener {
    ...
    public void setFuncionarioFormulario(Funcionario f){
        ...
        if(f == null){ // Se o parâmetro estiver nulo, limpa o formulário.
    ...
    private void initComponents() {
        ...
        lblNumero_celular = new JLabel("Número do celular: ");
        posicionador = new GridBagConstraints();
        ...
        posicionador = new GridBagConstraints();
        posicionador.gridy = 13; // Polição da linha (vertical).
        posicionador.gridx = 0; // Posição da coluna (horizontal).
        posicionador.anchor = java.awt.GridBagConstraints.LINE_END; // Ancoragem a direita.
        pnlDadosCadastrais.add(lblCargo, posicionador); // O add adiciona o rótulo no painel.  
                
        cbxCargo = new JComboBox();
        posicionador = new GridBagConstraints();
        posicionador.gridy = 13; // Posição da linha (vertical).
        posicionador.gridx = 1; // Posição da coluna (horizontal).
        posicionador.anchor = java.awt.GridBagConstraints.LINE_START;//ancoragem a esquerda.
        ...
        if(arg0.getActionCommand().equals(btnGravar.getActionCommand())) {
            ...
            if(f != null) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Erro ao salvar funcionário: " + ex.getMessage(), "Salvar", 
